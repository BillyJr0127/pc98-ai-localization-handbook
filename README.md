...
日版基本穩定後，再建立台詞 Excel 匯出／分批匯入與遊戲適配器；先跑通教材人工範例。
...
第三案例尚未完成全文中文化；近期的整冊字形預檢與人工編譯測試通過，不能當成最新整冊已成功安裝或全路線驗收。聲音與速度仍有未完整驗證的分支。首作目前使用即時 YM2203 軟體合成，不再只是早期預錄 PCM 方案。
